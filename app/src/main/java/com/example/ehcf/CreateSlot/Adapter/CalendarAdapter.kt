...
class CalendarAdapter(private val context: Context,
    ...
    private fun makeItemDisabled(holder: ViewHolder) {
        holder.txtDay!!.setTextColor(ContextCompat.getColor(context, R.color.main_color))
        holder.txtDayInWeek!!.setTextColor(ContextCompat.getColor(context, R.color.main_color))
    ...
    private fun makeItemSelected(holder: ViewHolder) {
        ...
        holder.linearLayout!!.setBackgroundColor(ContextCompat.getColor(context, R.color.main_color))
        holder.linearLayout!!.isEnabled = false
    }
