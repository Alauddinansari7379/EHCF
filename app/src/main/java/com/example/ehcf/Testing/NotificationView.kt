...
import com.example.ehcf.BuildConfig
...
class NotificationView : AppCompatActivity(), View.OnClickListener {
...
//            }
            ...
            val retrofitData = retrofitBuilder.uploadImage("1", MultipartBody.Part.createFormData("image", file.name),
    ...
    companion object {
        ...
        val CAMERA_PIC_REQUEST = 1111

        private val TAG = NotificationView::class.java.getSimpleName()
