...
public class DoctorNote {
    ...
    public String getStart_follow_up_date() {
        return start_follow_up_date;
    }
    ...
    public String follow_doctor() {
        return follow_doctor;
    }

    public void follow_doctor(String follow_doctor) {
        this.follow_doctor = follow_doctor;
    }
