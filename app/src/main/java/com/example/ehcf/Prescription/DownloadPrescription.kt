...
import com.example.ehcf.databinding.ActivityDownloadPrescriptionBinding


class DownloadPrescription : AppCompatActivity() {
    private lateinit var binding:ActivityDownloadPrescriptionBinding
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityDownloadPrescriptionBinding.inflate(layoutInflater)
