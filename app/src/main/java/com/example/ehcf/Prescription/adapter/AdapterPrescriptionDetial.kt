...
//        holder.medicines.text = list.medicine[position].medicineName
//        holder.timing.text = list.medicine[position].timing
//        holder.intake.text = list.medicine[position].intake
//        holder.frequency.text = list.medicine[position].frequency
//        holder.duration.text = list.medicine[position].duration
