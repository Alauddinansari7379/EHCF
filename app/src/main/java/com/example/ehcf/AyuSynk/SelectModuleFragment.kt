...
import com.example.ehcf.AyuSynk.MainActivity
import com.example.ehcf.R
import com.example.ehcf.databinding.FragmentSelectModuleBinding
import com.example.ehcf.AyuSynk.NewUI.RecordHeartSound
        ...
        binding!!.imgBack.setOnClickListener {
            SweetAlertDialog(requireContext(), SweetAlertDialog.WARNING_TYPE)
                ...
                .setConfirmClickListener { sDialog ->
                    sDialog.cancel()
                    startActivity(Intent(requireContext(), com.example.ehcf.Fragment.MainActivity::class.java))
                }
